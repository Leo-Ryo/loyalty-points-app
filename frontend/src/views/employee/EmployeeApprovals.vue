...
.refresh-btn { padding: 7px 14px; border: 1px solid #E5E5E5; border-radius: 10px; background: transparent; font-size: 13px; cursor: pointer; transition: all 0.15s; }
...
.approval-card { background: #FFFFFF; border: 2px solid #E5E5E5; border-radius: 20px; overflow: hidden; transition: all 0.2s; }
.approval-card:hover { border-color: #111111; }
.approval-header { display: flex; align-items: center; gap: 12px; padding: 16px; border-bottom: 1px solid #F5F5F5; }
.approval-avatar { width: 44px; height: 44px; border-radius: 50%; background: #111111; color: #FFF; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 18px; flex-shrink: 0; }
.approval-info { flex: 1; }
.approval-customer { font-weight: 700; font-size: 15px; margin: 0; }
.approval-meta { font-size: 12px; color: #525252; margin: 2px 0 0; }
...
.customer-pts { font-size: 13px; color: #525252; background: #F5F5F5; padding: 6px 12px; border-radius: 8px; }
.approval-actions { display: grid; grid-template-columns: 1fr 1fr; border-top: 1px solid #F5F5F5; }
.action-btn { padding: 14px; border: none; font-family: inherit; font-size: 14px; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 6px; transition: all 0.15s; }
.btn-reject { background: #FAFAFA; color: #DC2626; border-right: 1px solid #F5F5F5; }
...
.spinner.dark { border-color: rgba(0,0,0,0.15); border-top-color: #DC2626; }
