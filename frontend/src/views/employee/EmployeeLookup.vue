...
.search-bar {
  ...
  background: #FFFFFF; border: 2px solid #E5E5E5; border-radius: 14px; padding: 10px 16px;
  transition: border-color 0.15s;
}
.search-bar:focus-within { border-color: #111111; }
.search-icon { font-size: 16px; flex-shrink: 0; }
.search-input { flex: 1; border: none; outline: none; font-family: inherit; font-size: 15px; background: transparent; }
...
.filter-label { font-size: 12px; color: #525252; white-space: nowrap; }
.filter-select {
  padding: 6px 10px; border: 1px solid #E5E5E5; border-radius: 8px;
  font-family: inherit; font-size: 13px; outline: none; cursor: pointer; background: #FFF;
}
.sort-dir-btn {
  padding: 6px 12px; border: 1px solid #E5E5E5; border-radius: 8px; background: #FFF;
  font-family: inherit; font-size: 12px; font-weight: 600; cursor: pointer; transition: all 0.15s;
}
.sort-dir-btn:hover { background: #111; color: #FFF; border-color: #111; }
...
.result-item:hover { border-color: #111111; }
.result-item--selected { border-color: #111111; background: #F9F9F9; }
.result-avatar {
...
.result-meta { font-size: 12px; color: #525252; margin: 2px 0 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.result-pts { font-weight: 700; font-size: 13px; color: #111111; white-space: nowrap; }

/* Customer card */
.customer-card { background: #FFFFFF; border: 2px solid #111111; border-radius: 20px; padding: 1.5rem; display: flex; flex-direction: column; gap: 1.25rem; }
.customer-header { display: flex; align-items: center; gap: 1rem; }
.avatar-lg { width: 56px; height: 56px; border-radius: 50%; background: #111111; color: #FFF; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 22px; flex-shrink: 0; }
.customer-meta { flex: 1; }
.customer-name { font-size: 18px; font-weight: 800; margin: 0 0 5px; }
.customer-chips { display: flex; gap: 6px; flex-wrap: wrap; margin-bottom: 4px; }
.chip { font-size: 11px; color: #525252; background: #F5F5F5; padding: 3px 8px; border-radius: 6px; }
...
.pts-num { font-size: 26px; font-weight: 900; color: #111111; line-height: 1; }
.pts-label { font-size: 12px; color: #A3A3A3; }

/* Actions */
.action-section { border-top: 1px solid #F0F0F0; padding-top: 1rem; }
...
.bill-input-wrap { display: flex; align-items: center; border: 2px solid #E5E5E5; border-radius: 10px; padding: 8px 12px; gap: 4px; transition: border-color 0.15s; }
.bill-input-wrap:focus-within { border-color: #111111; }
...
.reward-row { display: flex; align-items: center; justify-content: space-between; padding: 10px 12px; border: 1px solid #E5E5E5; border-radius: 10px; gap: 12px; }
.reward-row.reward--locked { opacity: 0.45; }
.reward-info { flex: 1; }
.reward-name { font-size: 13px; font-weight: 600; margin: 0; }
.reward-pts { font-size: 12px; color: #525252; margin: 2px 0 0; }

.action-btn { padding: 8px 16px; border-radius: 10px; font-family: inherit; font-size: 13px; font-weight: 700; cursor: pointer; border: none; transition: all 0.15s; display: flex; align-items: center; gap: 6px; white-space: nowrap; }
.btn-primary { background: #111111; color: #FFFFFF; }
.btn-primary:hover:not(:disabled) { background: #333; }
.btn-outline { background: transparent; border: 2px solid #111111; color: #111111; }
.btn-outline:hover:not(:disabled) { background: #111111; color: #FFF; }
.action-btn:disabled { opacity: 0.35; cursor: not-allowed; }

.history-list { display: flex; flex-direction: column; gap: 6px; max-height: 260px; overflow-y: auto; }
.history-item { display: flex; align-items: center; gap: 10px; padding: 8px 10px; border: 1px solid #F0F0F0; border-radius: 10px; }
